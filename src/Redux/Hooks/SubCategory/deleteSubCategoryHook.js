...
import { deleteSubCategoryAction } from '../../Actions/SubCategoryAction';


const DeleteSubCategoryHooks = () => {
...
const handelDelete = ()=>{
   ...
   dispatch(deleteSubCategoryAction(deletedId.current))
...
export default DeleteSubCategoryHooks